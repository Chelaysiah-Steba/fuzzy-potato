  ...
  div(
    ...
    div(
      ...
      tags$div(
        ...
        ",
        "DEVELOPERS • OLIVE OPREL • CHELAYSIAH STEBA • SUPERVISOR • BAS VAN GESTEL • PLAYTESTERS • AVY EESTERMANS • REMCO OPREL • CASPER WERKMAN • BUILT WITH R & SHINY • THANK YOU FOR PLAYING RSCAPING THE BUNKER •"
      )
    ),
    br(),
    br(),
